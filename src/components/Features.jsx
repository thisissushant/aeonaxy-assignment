  ...
  return (
    <div className="grid grid-cols-7 gap-4 mx-10 m-4">
      ...
      <div className="border-solid border-2 rounded-lg p-3">
        ...
        <Button className="bg-transparent text-black border-solid border-2 border-black my-4 hover:text-white">
          Sign Up
        </Button>
      </div>
      <div className="border-solid border-2 rounded-lg p-3">
      ...
      <div className="border-solid border-2 rounded-lg p-3">
        ...
        <Button className="bg-blue-500 text-white border-solid border-2 border-blue-800 my-4 hover:text-white">
          Sign Up
        </Button>
      </div>
      <div className="border-solid border-2 rounded-lg p-3">
