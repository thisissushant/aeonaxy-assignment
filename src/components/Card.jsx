          ...
          <div className="ml-2 mt-3">
            ...
            <div className="mt-5">
              ...
              <p className="font-thin">
                When you want powerful scheduling automation
              </p>
            </div>
          </div>
          <div className="absolute inset-x-0 bottom-0 h-16 ml-6">
        ...
        <div className="relative w-40 h-80 m-2 rounded-lg bg-sky-50">
          <div className="ml-2 mt-3">
            ...
            <div className="mt-5">
              ...
              <p className="font-thin">
                When you need customization, integration, and basic team
                features
              </p>
            </div>
          </div>
        ...
        <div className="relative w-40 h-80 m-2 rounded-lg bg-gray-800 text-white">
          <div className="ml-2 mt-3">
            ...
            <div className="mt-5">
              ...
              <p className="font-thin">
                When your 30-member team needs advanced security, control, and
                support
              </p>
            </div>
          </div>
